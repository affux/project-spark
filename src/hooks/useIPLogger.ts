...
export type IPActionType = 'login' | 'logout' | 'order_placed' | 'payout_request' | 'profile_update' | 'postpaid_repayment' | 'crypto_payment' | 'payment_details_update' | 'kyc_submission';
