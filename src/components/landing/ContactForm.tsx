...
type ContactFormProps = React.ComponentPropsWithoutRef<'form'>;

export const ContactForm = React.forwardRef<HTMLFormElement, ContactFormProps>(({ className, ...props }, ref) => {
